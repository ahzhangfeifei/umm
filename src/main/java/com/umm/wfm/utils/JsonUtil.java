...
import com.umm.ngsp.ddg.util.jackjson.namingstrategy.PropertyTranslateStrategy;
import com.umm.ngsp.ddg.util.jackjson.namingstrategy.UnderlineFilterStrategy;
import com.umm.ngsp.ddg.util.jackjson.serialize.JackJsonNamingFormat;
import com.umm.operation.platform.base.json.JsonFormatter;
...
public class JsonUtil extends JsonFormatter {
    ...
    private static final boolean CHECK_FILE_FLAG = true;
    ...
    private static ObjectMapper setMapperConfig(ObjectMapper mapper, Object... configObj) {
        ...
        if (configObj != null && configObj.length == 1 && configObj[0] instanceof Set) {
            ...
            FilterProvider filterProvider = new SimpleFilterProvider().addFilter(FILTER_KEY,
